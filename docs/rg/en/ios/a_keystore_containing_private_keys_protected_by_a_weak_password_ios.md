...
An application uses a keystore, protected by a weak password, containing private keys. This can lead to a forgery of key information. An encryption key must not be stored in a location with public access.
