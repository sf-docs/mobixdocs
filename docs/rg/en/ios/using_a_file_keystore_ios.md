...
An application uses a file key storage. This can lead to a forgery of key information. An encryption key must not be stored in a location with public access.
