...
An application uses a readable keystore containing private keys protected by a weak password. An encryption key must not be stored in a location with public access and a keystore and keys stored in it must be protected by a strong password.
