...
An application uses a key store protected by a weak password that contains public keys. A keystore and the keys stored in it must be protected by a strong password.
